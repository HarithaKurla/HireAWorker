...
//                    ListView lv = (ListView)   findViewById(R.id.ListerLV);
                        list.add(new RegistrationInfo(response.get(i).getFname(), response.get(i).getPhonenumber(),response.get(i).getExperience(),response.get(i).getCost()));

                    }
                    Log.d("list view response is" ,"   kkkk"+list);
...
//
                    ...
                    Toast.makeText(getApplicationContext(), "No workers found", Toast.LENGTH_SHORT).show();
